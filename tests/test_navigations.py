...
class TestNavigation:    
    def test_navigate_from_main_page_to_account(self, page_utils: PageUtils):
        ...
        loginBtnIsDisplayed = page_utils.find_clickable_element(LoginPageLocators.LOGIN_BUTTON).is_displayed()
        assert loginBtnIsDisplayed == True
    ...
    def test_navigate_from_account_to_constuctor_is_possible(self, steps: Steps, page_utils: PageUtils):
        ...
        constructorHeaderIsDisplayed = page_utils.find_element(IngredientsLocators.HEADER_LABEL).is_displayed()
        assert constructorHeaderIsDisplayed == True
